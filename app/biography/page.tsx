          ...
          <div className="container mx-auto py-12 md:py-24">
            <motion.div variants={fadeInUp}>
              ...
              <p className="mt-4 text-xl md:text-2xl">
                ...
                <strong>STB Le Havre</strong>, showcasing his talent early on.
                His impressive skills on the court led to him being drafted{" "}
                ...
                significant roles with the <strong>Indiana Pacers</strong> and
                the <strong>Washington Wizards</strong>. His defensive prowess
                and rebounding skills earned him a reputation as a{" "}
          ...
          <div className="container mx-auto py-12 md:py-24">
            <motion.div variants={fadeInUp}>
              ...
              <p className="mt-4 text-xl md:text-2xl">
                ...
                is dedicated to{" "}
                <strong>nurturing strong, vibrant communities</strong>. Our
                focus is on fostering{" "}
                <strong>service, leadership, and mentorship</strong> both
                locally and globally. Our vision is to impact the lives of
                countless children and adults, instilling in them a{" "}
                <strong>healthy self-image</strong>, the ability to give and
                receive love, and the drive to contribute positively to one
                another and our planet. This ripple effect is our path to
                creating a <strong>brighter future for all</strong>.
                <br />
                <br />
          ...
          <div className="container mx-auto py-12 md:py-24">
            <motion.div variants={fadeInUp}>
              ...
              <p className="mt-4 text-xl md:text-2xl">
                ...
                <strong>business ventures</strong>. He has been actively
                involved in community projects, demonstrating a deep connection
                to his diverse roots and a commitment to giving back. Following
                his retirement, Mahinmi embarked on a mission to{" "}
                <strong>revolutionize the sports industry</strong> in{" "}
                <strong>Africa</strong>, beginning with <strong>Benin</strong>,
                his father&apos;s homeland where he founded a company focusing
                on <strong>sports</strong> with the goal of elevating
                competition levels, encouraging creativity, and inspiring new
                generations of athletes and sports entrepreneurs. His efforts
                aim to transform the African sports landscape into a vibrant
                ...
                <strong>professional achievement</strong>. From his early days
                in France to his triumphs in the NBA, and now his visionary work
                in Africa, Mahinmi&apos;s journey reflects his diverse
                background and commitment to making a lasting impact in the
                world of sports.
              </p>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto py-12 md:py-24">
            <motion.div variants={fadeIn}>
              ...
              <p className="text-center mt-4 mb-8 text-xl md:text-2xl">
                Explore Ian&apos;s journey through a curated collection of
                moments from his career and foundation events.
              </p>
