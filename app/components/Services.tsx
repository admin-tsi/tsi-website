      ...
      >
        <div className="flex flex-col justify-between p-4 m-4 sm:w-full lg:w-3/5">
          <div className="flex items-center">
            ...
            <h2 className="text-2xl font-semibold mx-4 mb-2 sm:text-3xl">
              {title}
            </h2>
          </div>
          <p className="text-md md:text-lg">{description}</p>
          <div className="bg-white py-4 px-2 rounded-full w-full md:w-2/6 text-center font-medium hover:scale-105 transition duration-300 ease-in-out">
            <a
              href={url}
              target="_blank"
...
const Services: React.FC = () => {
  ...
  return (
    <section ref={ref} className="font-clash relative" id="services">
      <motion.h3 className="text-4xl md:text-8xl text-center font-medium text-primary">
        Our services
      </motion.h3>
