...
function ColorChangeOnScrollGsap() {
    ...
    sectionColor.forEach((colorSection, i) => {
      ...
      const prevBgColor = i === 0 ? '' : (sectionColor[i - 1] as HTMLElement).dataset.bgcolor;
      const prevTextColor = i === 0 ? '' : (sectionColor[i - 1] as HTMLElement).dataset.textcolor;
