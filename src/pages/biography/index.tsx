  ...
  return (
    ...
    >
      ...
      <section className="mt-44 ">
        <div className="container mx-auto flex flex-col md:flex-row items-start py-12 md:py-24">
          <div className="w-full md:w-1/2 text-center md:text-left px-4">
            <div>
              ...
              <p className="text-xl md:text-2xl font-light mt-4">
                ...
                professional basketball player. At 611 and 250 lb, he played the
                center position and was selected with the 28th overall pick in
                the 2005 NBA draft by the San Antonio Spurs. In the summer of
                2006, Mahinmi signed a contract to play for Pau Orthez in
                Frances top professional league. He averaged 4.3 points and 3.2
                rebounds in 12.7 minutes in the 2006–07 season, helping the team
                win the French Cup.
              </p>
